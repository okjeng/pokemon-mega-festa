...
export const STAMP_PAGE: InfoPageData = {
  icon: "🎫",
  title: "스탬프랠리",
  summary: "지하철 5개 역에서 테마별 스탬프를 모으면 개수별 경품을 받을 수 있습니다. 완주 시 약 6~8시간 예상됩니다.",
  cards: [...STAMPS, ...STAMP_REWARDS],
  details: [
    "참여 방법: 롯데백화점 부산본점에서 스탬프 대지를 수령 → 5개 역을 방문해 스탬프를 찍음 → 롯데백화점으로 돌아와 개수에 맞는 경품을 수령합니다.",
    "5개 역을 모두 도는 완주 기준 예상 소요시간은 약 6~8시간입니다(이동시간 포함, 지하철 코스 페이지의 역별 체류시간 합산 기준). 시간이 부족하다면 스탬프 3개만 채워도 경품을 받을 수 있습니다.",
